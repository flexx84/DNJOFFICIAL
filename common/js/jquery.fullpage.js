    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            element.prev().addClass('prev').addClass('next').siblings().removeClass('prev');
            element.prev().prev().addClass('pprev').siblings().removeClass('pprev');
            lazyLoad(element);
